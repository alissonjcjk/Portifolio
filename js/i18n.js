const translations = {
  pt: {
    ...
    "exp.nexia.title": "Desenvolvedor de Inteligência Artificial (Autônomo)",
    "exp.nexia.date": "Mar 2025 - Abr 2026",
    "exp.nexia.l1": "Construção de arquiteturas de agentes e sistemas multiagentes, com integração de modelos LLM para soluções baseadas em IA.",
    "exp.nexia.l2": "Implementação de pipelines RAG ponta a ponta, incluindo estruturação do fluxo, estratégias de chunking e geração de embeddings.",
    "exp.nexia.l3": "Integração de sistemas via APIs e orquestração de fluxos para automação de processos.",
    "exp.nexia.l4": "Participação no desenvolvimento de soluções de visão computacional baseadas em análise visual.",
  ...
  en: {
    ...
    "exp.nexia.title": "Freelance Artificial Intelligence Developer",
    "exp.nexia.date": "Mar 2025 - Apr 2026",
    "exp.nexia.l1": "Built agent and multi-agent architectures, integrating LLMs into AI-based solutions.",
    "exp.nexia.l2": "Implemented end-to-end RAG pipelines, including flow design, document chunking strategies, and embedding generation.",
    "exp.nexia.l3": "Integrated systems through APIs and orchestrated workflows to automate processes.",
    "exp.nexia.l4": "Contributed to the development of computer vision solutions based on visual analysis.",
