const translations = {
  pt: {
    ...
    "proj.dashboard.desc": "Plataforma web para análise e visualização de dados de postos de combustível, com processamento de planilhas, geração de relatórios e dashboards interativos. Sistema utilizado para otimizar a gestão de frotas e controle de custos.",
    "proj.vet.title": "Sistema de Gestão Veterinária",
    "proj.vet.desc": "Aplicação full stack para clínicas veterinárias com gerenciamento de consultas, prontuários de animais, controle de estoque e agendamentos. Interface responsiva e API RESTful completa com autenticação JWT.",
    "proj.other.title": "Outros Projetos Notáveis",
    "proj.face.title": "Reconhecimento Facial (PyTorch)",
    "proj.face.desc": "Modelo de deep learning para classificação de expressões faciais, desenvolvido durante pesquisa no Voxar Labs.",
    "proj.bora.title": "Plataforma Social — Bora Impactar",
    "proj.bora.desc": "Features para plataforma social do Governo de Pernambuco para conectar iniciativas de impacto social e voluntários.",
    "proj.sti.title": "Microsserviços Universitários — STI-UFPE",
    "proj.sti.desc": "Módulos de software institucional com React.js, orquestração via Kubernetes e resiliência de microsserviços.",
  ...
  en: {
    ...
    "proj.dashboard.desc": "Web platform for analyzing and visualizing fuel station data, with spreadsheet processing, report generation, and interactive dashboards. System used to optimize fleet management and cost control.",
    "proj.vet.title": "Veterinary Management System",
    "proj.vet.desc": "Full stack application for veterinary clinics with appointment management, animal records, inventory control, and scheduling. Responsive interface and complete RESTful API with JWT authentication.",
    "proj.other.title": "Other Noteworthy Projects",
    "proj.face.title": "Facial Recognition (PyTorch)",
    "proj.face.desc": "Deep learning model for facial expression classification, developed during research at Voxar Labs.",
    "proj.bora.title": "Social Platform — Bora Impactar",
    "proj.bora.desc": "Features for the Pernambuco Government's social platform to connect social impact initiatives and volunteers.",
    "proj.sti.title": "University Microservices — STI-UFPE",
    "proj.sti.desc": "Institutional software modules with React.js, Kubernetes orchestration, and microservices resilience.",
